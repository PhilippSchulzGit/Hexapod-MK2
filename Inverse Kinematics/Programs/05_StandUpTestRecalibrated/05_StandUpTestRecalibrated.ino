...
float servoCalibration(int servoNumber, float targetPosition) {
  ...
  // the following code was removed with new calibration for servo 6 in the change from -90/90° to -45/135°
  // check servoNumber
  ...
  //return newPosition;   // old return
  return m[servoNumber-1]*targetPosition + b[servoNumber-1];
}
